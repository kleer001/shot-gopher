@echo off
REM =============================================================================
REM Run Mocap - Auto-activating wrapper (Windows)
REM =============================================================================
REM Activates the vfx-pipeline conda environment and runs run_mocap.py
REM
REM Usage:
REM   src\run-mocap.bat <project_dir> [options]
REM
REM Example:
REM   src\run-mocap.bat C:\path\to\projects\My_Shot
REM =============================================================================
